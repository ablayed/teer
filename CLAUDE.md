...
| **6b** | Produits — pagination serveur (lot 25, keyset OFFSET + index 0036), recherche titre/SKU côté serveur, onglet Achats (`?tab=achats`) | 0036 | ✅ Done (E2E 15/15 verts sur chromium/pixel-7/iphone-14). |
