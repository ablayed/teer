...
const serverEnvSchema = z.object({
  ...
  SHOPIFY_TEER_PUBLIC_API_KEY: z.string().optional(),
  SHOPIFY_TEER_PUBLIC_API_SECRET: z.string().optional(),
  SHOPIFY_TOKEN_ENCRYPTION_KEY: z.string().optional(),
  SHOPIFY_TOKEN_ENCRYPTION_KEY_PREVIOUS: z.string().optional(),
  CONNECTOR_CREDENTIALS_ENCRYPTION_KEY: z.string().optional(),
  CONNECTOR_CREDENTIALS_ENCRYPTION_KEY_PREVIOUS: z.string().optional(),
...
const rawEnvironment = {
  ...
  SHOPIFY_TEER_PUBLIC_API_KEY: process.env.SHOPIFY_TEER_PUBLIC_API_KEY,
  SHOPIFY_TEER_PUBLIC_API_SECRET: process.env.SHOPIFY_TEER_PUBLIC_API_SECRET,
  ...
  CONNECTOR_CREDENTIALS_ENCRYPTION_KEY: process.env.CONNECTOR_CREDENTIALS_ENCRYPTION_KEY,
  CONNECTOR_CREDENTIALS_ENCRYPTION_KEY_PREVIOUS:
    process.env.CONNECTOR_CREDENTIALS_ENCRYPTION_KEY_PREVIOUS,
...
export const env = {
  ...
  ...serverEnvSchema.parse({
    ...
    SHOPIFY_TEER_PUBLIC_API_KEY: rawEnvironment.SHOPIFY_TEER_PUBLIC_API_KEY,
    SHOPIFY_TEER_PUBLIC_API_SECRET: rawEnvironment.SHOPIFY_TEER_PUBLIC_API_SECRET,
    ...
    CONNECTOR_CREDENTIALS_ENCRYPTION_KEY: rawEnvironment.CONNECTOR_CREDENTIALS_ENCRYPTION_KEY,
    CONNECTOR_CREDENTIALS_ENCRYPTION_KEY_PREVIOUS:
      rawEnvironment.CONNECTOR_CREDENTIALS_ENCRYPTION_KEY_PREVIOUS,
