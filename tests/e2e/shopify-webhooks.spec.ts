...
// Playwright charge la configuration de test dans process.env (cf. playwright.config). Le serveur
// Next et ce signeur doivent voir le MÊME SHOPIFY_API_SECRET — posé par ci.yml (job
// test-e2e-phase1) ou par .env.test/.env.test.local en local, jamais dérivé ici.
