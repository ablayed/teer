-- 0113 — Rend la réduction post-assignation atteignable sur le flux cash réel.
--
-- Programmer/assigner pose cash_state='expected'; démarrer_livraison le conserve.
-- La fonction 0112 exigeait à tort not_due et rendait donc ce chemin inatteignable.
-- Les états de livraison terminaux restent explicitement exclus, même si leur cash
-- est not_due après refus ou retour.
