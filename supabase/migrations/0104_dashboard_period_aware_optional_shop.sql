-- 0104 — p_shop_id optionnel pour les agrégats period-aware de 0103.

drop function public.get_dashboard_top_products(uuid, uuid, timestamptz, timestamptz);
drop function public.get_dashboard_shop_performance(uuid, uuid, timestamptz, timestamptz);
drop function public.get_dashboard_cod_breakdown(uuid, uuid, timestamptz, timestamptz);
...
revoke all on function public.get_dashboard_cod_breakdown(uuid, timestamptz, timestamptz, uuid) from public, anon;
grant execute on function public.get_dashboard_cod_breakdown(uuid, timestamptz, timestamptz, uuid) to authenticated;
...
revoke all on function public.get_dashboard_top_products(uuid, timestamptz, timestamptz, uuid) from public, anon;
grant execute on function public.get_dashboard_top_products(uuid, timestamptz, timestamptz, uuid) to authenticated;
